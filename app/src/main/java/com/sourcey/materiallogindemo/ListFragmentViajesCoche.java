 ...
 */
public class ListFragmentViajesCoche extends ListFragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,Bundle saveInstanceState){
        ...
        List<String> listaCoches = Farcade.obtenerCoches(Farcade.listaViajes);

        adapter = new ArrayAdapter<String>(getActivity(),R.layout.row_viajes,R.id.txtitem,listaCoches);
